...
namespace ExtraLesson2.Controllers
{
    ...
    {
        // New in Extra Lesson 2 — a business rule: a todo may have at most this many tags.
        // Declared as a const so the value is visible in error messages and is easy to tweak.
        ...
        {
            // Attribute-level validation on AttachTagRequest (Range, HexColor) has already
            // passed by the time we enter the action — [ApiController] would have returned
            // 400 automatically otherwise.
            //
            // But "a todo can have at most 5 tags" is a BUSINESS rule, not a shape rule.
            // It depends on the runtime state of the database (how many rows already exist
            // for this todo), which attributes can't reach. We check it explicitly in the
            // controller — Technique 2 of this lesson.
